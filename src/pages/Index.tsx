...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 to-blue-50/80 p-4 md:p-8">
      <header className="mb-8 text-center">
        <h1 className="text-5xl font-bold bg-gradient-to-br from-chatbot-primary via-chatbot-dark to-chatbot-accent bg-clip-text text-transparent">
